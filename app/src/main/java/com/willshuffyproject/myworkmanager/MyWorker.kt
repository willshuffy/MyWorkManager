...
class MyWorker(context: Context, workerParams: WorkerParameters) : Worker(context, workerParams) {
    ...
    companion object{
        ...
        const val APP_ID = "c5bf0e763f34d0ecf9fd0fda46433038"
        ...
        client.post(url, object : AsyncHttpResponseHandler(){
            override fun onSuccess(statusCode: Int, headers: Array<Header?>?, responseBody: ByteArray) {
                ...
                try {
                    ...
                    showNotification("Get Crrent Weather Not Success", e.message)
            ...
            override fun onFailure(statusCode: Int, headers: Array<Header?>?, responseBody: ByteArray?, error: Throwable) {
                ...
                //ketika proses gagal, maka jobfinished dengan parameter true, yang artinya job perlu direschedule
